...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="app.php#text-data">Text Data</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="app.php#image-data">Image Data</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Results</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Services -->
    <section id="result">
      <h3 class="head">Please Refresh the page if the result is not visible</h3>
      <div class="res">
        <?php 
          ...
          if(mysqli_num_rows($result) > 0){
            ...
            <table class="table table-hover">
              <caption>Image Data Results</caption>
              <tr>
                <th>Time Stamp</th>
                <th>Diagnosis</th>
      ...
      <div class="res">
        <?php 
          ...
          if(mysqli_num_rows($result1) > 0){
            ?>
            <table class="table table-hover">
              <caption>Text Data Results</caption>
              <tr>
                <th>Time Stamp</th>
                <th>Diagnosis</th>
              </tr>
